...
Na začátku vložíme potřebné importy:
...
## 2. Definujeme animační varianty

Animační varianty pro celou stránku, kontejner, jednotlivé prvky a tlačítka:
...
## 3. Hlavní komponenta `SignUpPage` a definice stavů
...
Tímto je registrační stránka kompletní.
